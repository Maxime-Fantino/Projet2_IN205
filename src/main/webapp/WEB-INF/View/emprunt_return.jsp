	      ...
	      <form action="/TP3Ensta/emprunt_return" method="post" class="col s12">
	        <div class="row">
	          <div class="input-field col s12">
	            <select name="idEmprunt" class="browser-default">
	              <option value="" disabled selected>-- Retour d'Emprunt --</option>
                  ...
                  <c:forEach var="emprunt" items="${listeEmpruntsCurrent}">
                    <option value="${emprunt.primaryKey}" selected>"${emprunt.livre.titre}" emprunté par ${emprunt.membre.prenom} ${emprunt.membre.nom}</option>
                  </c:forEach>
	            </select>
	          </div>
	        </div>
