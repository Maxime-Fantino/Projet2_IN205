...
<body>
  ...
  <main>
    <section class="content">
      ...
      <div class="row">
      <div class="container">
      <h5>Détails du membre n°${membre.primaryKey}</h5> <!-- TODO : remplacer 007 par l'id du membre -->
        <div class="row">
	      <form action="/TP3Ensta/membre_details?id=${membre.primaryKey}" method="post" class="col s12"> <!-- TODO : remplacer idDuMembre par l'id du membre -->
	        <div class="row">
	          ...
	          <div class="input-field col s4">
	            <input id="prenom" type="text" value="${membre.nom}" name="${membre.prenom}"> <!-- TODO : remplacer prenomDuMembre par le pr�nom du membre -->
	        ...
	        <table class="striped">
              ...
              <tbody id="results">
                ...
                <tr>
                  ...
                  <td>
                    <a href="emprunt_return?id=${emprunt.primaryKey}"><ion-icon class="table-item" name="log-in"></a>
                  </td>
                </tr>
                </c:forEach>
