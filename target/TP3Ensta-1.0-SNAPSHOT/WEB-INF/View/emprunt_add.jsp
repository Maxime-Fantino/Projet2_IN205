...
<%@ page import = "com.ensta.librarymanager.modele.Membre" %>
	      ...
	      <form action="/TP3Ensta/emprunt_add" method="post" class="col s12">
	        <div class="row">
	          <div class="input-field col s6">
	            <select name="idLivre" class="browser-default">
                  ...
                  <c:forEach var="livreDispo" items="${listeLivresDispos}">
                    <option value="${livreDispo.primaryKey}">${livreDispo.titre} ${livreDispo.auteur}</option>
                  </c:forEach>
	            </select>
	          </div>
	          <div class="input-field col s6">
	            <select name="idMembre" class="browser-default">
                  ...
                  <c:forEach var="membreDispo" items="${listeMembresDispos}">
                      <option value="${membreDispo}">${membreDispo.prenom} ${membreDispo.nom}</option>
                  </c:forEach>
	            </select>
	          </div>
	        </div>
